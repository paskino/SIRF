...
#   "alpha_35_gated_gates"  
  ...
  # "new_motion_rescaled_gamma_1.0_noprecond_alpha_1.0_gated_pdhg"
  # "new_motion_rescaled_gamma_{1.0}_noprecond_alpha_1.0_gated_gates"
  # "new_motion_rebin_noinitial_rescaled_gamma_1.0_noprecond_alpha_1.0_gated_gates"
  # "new_motion_rebin_rescaled_gamma_2.8284_noprecond_alpha_1.0_gated_pdhg"
  # "new_motion_rebin_rescaled_gamma_1.0_noprecond_alpha_1.0_gated_pdhg"
  # "notrans_rebin_rescaled_gamma_2.8284_noprecond_alpha_1.0_gated_pdhg"
  # "notrans_rebin_rescaled_gamma_1.0_noprecond_alpha_1.0_gated_pdhg"
  # "new_motion_rebin_noinitial_rescaled_gamma_1.0_noprecond_alpha_1.0_gated_gates"
  # "rebin_rescaled_gamma_1.0_alpha_1.0_ungated_pdhg"
  # "new_motion_rebin_rescaled_gamma_1.0_noprecond_alpha_5.0_gated_pdhg"
  "pdhg"
...
do 
  ...
  rsync -avz --exclude "tmp_*.hs" --exclude "tmp_*.s" \
     ...
     --progress . \
    sirfuser@130.246.214.97:/mnt/data/cardiac_resp/pet/recons/${run_name}
  
  # sirfuser@130.246.214.97:/mnt/data/cardiac_resp/pet/recons/pdhg
  # # sync parameters
